...
export const CardReview = ({rate, name, comment}) => {
  return (
    <div className="h-full w-full md:w-1/3 bg-white rounded-3xl border-[1.5px] border-gray-300 px-[32px] py-[28px]">
      <div className="w-full h-full flex flex-col justify-center md:justify-start items-start md:gap-3 gap-4">
